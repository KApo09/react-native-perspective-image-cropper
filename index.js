...
class CustomCrop extends Component {
  constructor(props) {
    ...
    this.state = {
      ...this.state,
      topLeft: new Animated.ValueXY(props.rectangleCoordinates
        ? this.imageCoordinatesToViewCoordinates(props.rectangleCoordinates.topLeft, true)
        : {
          x: 100,
          y: 100
        }),
      topRight: new Animated.ValueXY(props.rectangleCoordinates
      ...
      bottomLeft: new Animated.ValueXY(props.rectangleCoordinates
        ? this.imageCoordinatesToViewCoordinates(props.rectangleCoordinates.bottomLeft, true)
        : {
          x: 100,
          y: this.state.viewHeight - 100
        }),
      bottomRight: new Animated.ValueXY(props.rectangleCoordinates
    ...
    this.state = {
      ...this.state,
      overlayPositions: `${this.state.topLeftOverlay.x},${this.state.topLeftOverlay.y} ${this.state.topRightOverlay.x},${this.state.topRightOverlay.y} ${this.state.bottomRightOverlay.x},${this.state.bottomRightOverlay.y} ${this.state.bottomLeftOverlay.x},${this.state.bottomLeftOverlay.y}`
    };
  ...
  createPanResponser(corner, cornerKey) {
    return PanResponder.create({
      ...
      onPanResponderMove: (event, gestureState) => {
        const p1 = cornerKey === 'topLeft'
          ? `${this.state.topLeftOverlay.x + gestureState.dx},${this.state.topLeftOverlay.y + gestureState.dy}`
          : `${this.state.topLeftOverlay.x},${this.state.topLeftOverlay.y}`
        const p2 = cornerKey === 'topRight'
          ? `${this.state.topRightOverlay.x + gestureState.dx},${this.state.topRightOverlay.y + gestureState.dy}`
          : `${this.state.topRightOverlay.x},${this.state.topRightOverlay.y}`
        const p3 = cornerKey === 'bottomRight'
          ? `${this.state.bottomRightOverlay.x + gestureState.dx},${this.state.bottomRightOverlay.y + gestureState.dy}`
          : `${this.state.bottomRightOverlay.x},${this.state.bottomRightOverlay.y}`
        const p4 = cornerKey === 'bottomLeft'
          ? `${this.state.bottomLeftOverlay.x + gestureState.dx},${this.state.bottomLeftOverlay.y + gestureState.dy}`
          : `${this.state.bottomLeftOverlay.x},${this.state.bottomLeftOverlay.y}`
